                                ...
                                <div class="d-md-flex align-items-center mb-4">
                                    <div>
                                        ...
                                        <p class="card-subtitle">
                                            Isi form berikut untuk mengedit data warga
                                        </p>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" class="form-control" id="no_ktp" name="no_ktp"
                                                    required value="{{ $dataWarga->no_ktp }}">
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <label for="nama" class="form-label">Nama Lengkap</label>
                                            <input type="text" class="form-control" id="nama" name="nama"
                                                    required value="{{ $dataWarga->nama }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" class="form-control" id="agama" name="agama"
                                                    required value="{{ $dataWarga->agama }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" class="form-control" id="pekerjaan" name="pekerjaan"
                                                    required value="{{ $dataWarga->pekerjaan }}">
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <label for="telp" class="form-label">No. HP</label>
                                            <input type="text" class="form-control" id="telp" name="telp"
                                                    required value="{{ $dataWarga->telp }}">
                                        </div>
                                    </div>
